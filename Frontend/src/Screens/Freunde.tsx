import { faCommentDots, faExclamationTriangle, faHeart, faHeartBroken, faStar, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
            ...
            >
                ...
                <View style={[styles.row, {marginLeft: 15, height: 60}]}>
                    ...
                    <View style={[styles.row, { marginLeft: "auto", right: "5%" }]}>
                        ...
                        <TouchableOpacity onPress={() => { alert("Tier aus Freundesliste entfernt")/* Unfriend */ }} style={{marginRight:6}}>
