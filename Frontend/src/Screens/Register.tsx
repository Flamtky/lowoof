            ...
            <ScrollView style={[isLargeScreen ? { width: '43%', left: "28%" } : null, { height: 10, backgroundColor: MAINCOLOR }]}>
                ...
                <View style={{ backgroundColor: MAINCOLOR, height: 500 }}>
                    <View style={styles.inputContainer}>
                        ...
                        <SearchBar style={styles.input} placeholder={language.PROFILE.USR_LANG[currentLanguage]} value={userLanguage} onChange={(event: any) => { setUserLanguage(event.nativeEvent.text); }} />
